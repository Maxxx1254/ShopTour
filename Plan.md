# План проведения работ.
  ...
  ## Перечень автоматизируемых сценариев:
   ...
   ## Тестирование серверной части
        ...
        Ожидаемый результат: В DevTools получаем код 200 и status: "APPROVED".
        ...
        Ожидаемый результат: В DevTools получаем код 200 и status: "DECLINED".
        ...
        Ожидаемый результат: МОжидаемый результат: В DevTools получаем код 500 и error: "Internal Server Error".
